      ...
      {admin ?
        <><h1>Create a new exercise</h1>
          <form action="/exercises/create/" method="POST">
            ...
            <div>
              <input type="radio" id="difficultyChoice1" name="difficulty" value="beginner" />
              <label htmlFor="difficultyChoice1">Beginner</label>
              <input type="radio" id="difficultyChoice2" name="difficulty" value="intermediate" />
              <label htmlFor="difficultyChoice2">Intermediate</label>
              <input type='radio' id="difficultyChoice3" name="difficulty" value="expert" />
              <label htmlFor="difficultyChoice3">Expert</label>
            </div>
            <label>Exercise Muscle Group</label>
            <input type="text" name="muscle" required />
            <label>Exercise Equipment (Type none if no equipment required)</label>
            <input type="text" name="equipment" required />
            <label>Exercise Instructions</label>
            <textarea type="text" name="instructions" rows="4" cols="45" required />
            <label>Exercise Type</label>
            <div> 
              <input type="radio" id="typeChoice1" name="type" value="strength" />
              ...
              <input type="radio" id="typeChoice3" name="type" value="stretching" />
